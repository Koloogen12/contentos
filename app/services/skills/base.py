...
OUTPUT_LANGUAGE_DIRECTIVE = (
    ...
    "Имена собственные, бренды, цитаты в кавычках и числа сохраняй как в оригинале — "
    "не транслитерируй и не переводи. Если исходник англоязычный, просто перескажи "
    "смысл по-русски своими словами."
)
